...
#Course Objectives
The need for data stewardship in Earth systems science is due to the increased scale and complexity brought about by simultaneously examining many natural phenomena and their interactions. Students currently have little opportunity to learn fundamental data skills required for successful, collaborative, and reproducible research. AGRON 5XX/4XX will address this lack in a setting that is specific to Earth systems scientists with examples and data sets from their fields.

#Learning Outcome:
Students will become good data stewards through learning new tools to clearly organize, track, and communicate data-based work from data collection through analysis and publication. This will facilitate strong collaborative research skills and enable subsequent researchers to reproduce or expand upon completed projects. By creating a deeper understanding of data architectures and data manipulation, this course will prepare students to be Earth systems scientists with the ability to complete the entire research cycle in a responsible way.
