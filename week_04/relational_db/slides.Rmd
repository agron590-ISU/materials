...
We can do ETL from a "raw" database full of dumped .csv files intro a "production" database using queries. Or, we can use DBMS that is more robust and has ETL capabilities. 
